...
export default async function FlowPage({
  ...
  const currentStep = flow.steps.find((s) => s.status === "current")
    ...
    <div className="bg-neutral-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-neutral-400 mb-6">
          <Link href="/search?view=flows" className="hover:text-neutral-600 transition-colors">
            Learning Flows
          </Link>
          <span>/</span>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-4">
              ...
              <div className="rounded-2xl bg-white border border-neutral-100 p-5">
                ...
                <button
                  type="button"
                  className={`mt-4 w-full rounded-xl py-3 text-white text-sm font-medium flex items-center justify-center gap-2 transition-colors ${t.accentBg}`}
                >
