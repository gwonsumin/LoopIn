...
function EmptyState({ q, onReset }: { q: string; onReset: () => void }) {
  return (
    <div className="text-center py-20">
      <p className="text-neutral-400 text-sm">찾으시는 자료가 없어요</p>
      <button
        type="button"
        onClick={onReset}
            ...
            <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
              <SheetTrigger
                render={
                  <button
                    type="button"
                    className="flex items-center gap-2 px-4 py-2 rounded-xl border border-neutral-200 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors"
                  />
                }
              >
